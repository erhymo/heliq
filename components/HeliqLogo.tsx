...
export default function HeliqLogo({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" aria-label="Gå til forsiden" className="flex w-fit items-center gap-3 rounded-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
